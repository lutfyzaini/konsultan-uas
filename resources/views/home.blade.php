        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="order-1 lg:order-2 flex justify-center lg:justify-end">
                <div class="relative w-full max-w-md">
                    ...
                    <div class="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-lg p-4 flex items-center gap-3 border border-slate-100">
                        ...
                        <div>
                            <div class="text-sm font-semibold text-slate-800">Rating 4.9/5</div>
                            <div class="text-xs text-slate-400">dari 500+ ulasan</div>
                        </div>
                    </div>

                    {{-- Floating card: online --}}
                    <div class="absolute -top-4 -right-4 bg-white rounded-2xl shadow-lg p-3 flex items-center gap-2 border border-slate-100">
                        <div class="w-2.5 h-2.5 bg-teal-500 rounded-full animate-pulse"></div>
                        <span class="text-xs font-semibold text-slate-700">48 Ahli Online</span>
                    </div>
